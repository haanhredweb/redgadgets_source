	...
	<td>
		<fieldset class="adminform">
			...
			<table class="admintable" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="2">
						<a class="btn_attribute" href="javascript:addNewRow_attribute('attribute_table')">
							<span
								id="new_attribute"><?php echo "+ "; echo JText::_('COM_REDSHOP_NEW_ATTRIBUTE'); ?></span>
						</a>
					</td>
				</tr>
			</table>
...
<tr>
<td>
<table width="100%" cellpadding="2" border="0" id="attribute_table" cellspacing="2">
