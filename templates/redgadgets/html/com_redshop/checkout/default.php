...
$login_template_desc = '
    <table border="0" cellspacing="3" cellpadding="3" width="100%">
        <tbody>
            <tr>
                <td><label>{rs_username_lbl}:</label>{rs_username}</td>
            </tr>
            <tr>
                <td><label>{rs_password_lbl}:</label>{rs_password}</td>
            </tr>
            <tr>
                <td align="right">{forget_password_link}</td>
            </tr>
    ...
    <table width="100%" cellspacing="3" cellpadding="0" border="0">
        <tr>
            <!--<td align="right">{rs_login_back}</td>-->
            <td  align="right">{rs_login_button}</td>
        </tr>
    </table>';
...
else
{
	...
	if ($show_login)
	{
		...
		$login_template_desc = '<div class="mystretchermy" id="login_div" ' . $loginuserstyle . '><form action="' . JRoute::_('index.php') . '" method="post">' . $login_template_desc . '</form></div>';
	...
	<div class="mystretchermy" id="register_div" <?php echo $newuserstyle;?>>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td>
                    <span id="customer_registrationintro" <?php echo ($is_company == 1) ? 'style="display:none;"' : '';?>>
				        <?php echo REGISTRATION_INTROTEXT; ?>
                    </span>
                    <span id="company_registrationintro" <?php echo ($is_company == 1) ? '' : 'style="display:none;"';?>>
				        <?php echo REGISTRATION_COMPANY_INTROTEXT; ?>
                    </span>
                </td>
            </tr>
